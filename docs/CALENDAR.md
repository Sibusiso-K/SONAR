# SONAR Calendar — rest of 2026

All times **SAST (Africa/Johannesburg, UTC+2)** unless stated.
Machine-readable source: [`../data/calendar_events.json`](../data/calendar_events.json)
Importable file: [`../calendar/sonar-2026.ics`](../calendar/sonar-2026.ics)

**To import into Google Calendar:** Settings → Import & export → Import → select `sonar-2026.ics` → choose a calendar → Import.
...
## What is *not* on the calendar yet, and why
